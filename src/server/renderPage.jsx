  ...
  const html = `
    ...
    <html>
      <head>
        ...
        <meta name="description" content="An open source fractal analytics dashboard work application created with React and Redux. ">
        ...
        <link rel="icon" type="image/png" href="/static/favicons/favicon.ico" sizes="32x32" />
